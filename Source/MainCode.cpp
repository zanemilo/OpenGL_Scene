...
int main(int argc, char* argv[])
{
	...
	// load the shader code from the internal GLSL files
	g_ShaderManager->LoadShaders(
	...
	// Set texture units
	g_ShaderManager->setIntValue("objectTexture", 0); // Texture unit 0
	g_ShaderManager->setIntValue("overlayTexture", 1); // Texture unit 1
	g_ShaderManager->setFloatValue("mixRatio", 0.5f); // Initial mix ratio

	// Optionally, set toggle for overlay
	g_ShaderManager->setBoolValue("bUseOverlay", true); // Enable overlay
